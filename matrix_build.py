...
filters = [
    ...
    # not supported board features/addons
    {'env': "esp32", "USE_GPS": 1},
    {'env': "esp32", "USE_GYRO_LEVEL": 1},
    {'env': "esp32", "AZIMUTH_ALTITUDE_MOTORS": 1},
    {'env': "esp32", "DISPLAY_TYPE": 1},
    {'env': "mksgenl2", "USE_GPS": 1},
    {'env': "mksgenl2", "USE_GYRO_LEVEL": 1},
